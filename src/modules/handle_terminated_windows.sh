...
handle_terminated_windows(){
	...
	local local_terminated_window_ids="${event/'terminated: '/}" # Remove everything before including type name of list with window IDs
	local local_terminated_window_ids="${local_terminated_window_ids/'; existing: '*/}" # Remove list of existing window IDs
	# Obtain list of existing window IDs
	local local_existing_window_ids="${event/*'existing: '/}" # Remove everything including type name of list with window IDs
